...
void main() {
  group('Review.fromJson', (() {
    ...
    test('can handle Profile', (() {
      Profile writer = ProfileFactory().generateFake();
      Profile receiver = ProfileFactory().generateFake();
      Map<String, dynamic> json = {
        "id": 1,
        "created_at": "2021-01-01T00:00:00.000Z",
        "writer_id": writer.id,
  ...
  group("Review.fromJsonList", () {
    test('parses a list of Reviews from json', () {
      ...
      List<Review> reviews = Review.fromJsonList(jsonList);
    ...
    test('can handle an empty list', () {
      List<Review> reviews = Review.fromJsonList([]);
      expect(reviews, []);
    });
  });
  ...
  group("Review.toJson", (() {
    test("returns a json representation of the review", (() {
      Review review = ReviewFactory().generateFake();
  ...
  group("Review.compareTo", (() {
    ...
    test("ratings with text are rated higher", (() {
      Review review = ReviewFactory().generateFake();
      Review review2 = ReviewFactory().generateFake(
        text: NullableParameter(null),
      );
  ...
  group("AggregateReview.isSet Methods", (() {
    test("isSet returns true if the value is not 0", (() {
      AggregateReview review = AggregateReview(
        rating: 1,
        comfortRating: 1,
        safetyRating: 1,
        reliabilityRating: 1,
  ...
  group("AggregateReview.fromReviews", (() {
    test("returns an AggregateReview from a list of reviews", (() {
      Review review1 = ReviewFactory().generateFake(
        rating: 1,
      ...
      Review review3 = ReviewFactory().generateFake(
        rating: 3,
      ...
      AggregateReview aggregateReview1 = AggregateReview.fromReviews([review1]);
      ...
      AggregateReview aggregateReview2 = AggregateReview.fromReviews([review1, review1, review1]);
      ...
      AggregateReview aggregateReview3 = AggregateReview.fromReviews([review1, review2, review3]);
    ...
    test("returns an AggregateReview from an empty list", (() {
      List<Review> reviews = [];
      AggregateReview review = AggregateReview.fromReviews(reviews);
    ...
    test("returns zero if rating is not set", (() {
      ...
      AggregateReview aggregateReview1 = AggregateReview.fromReviews([review]);
      ...
      AggregateReview aggregateReview2 = AggregateReview.fromReviews([review, review, review]);
    ...
    test("discards null values", (() {
      ...
      List<Review> reviews = ReviewFactory().generateFakeList(length: 3);
      AggregateReview aggregateReview = AggregateReview.fromReviews(reviews);
      AggregateReview aggregateReviewWithNull = AggregateReview.fromReviews([review1, ...reviews]);
